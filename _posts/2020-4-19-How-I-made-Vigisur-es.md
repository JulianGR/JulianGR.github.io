...
I opted for Opens Sans and Monserrat for the typography and consisted colors (the palette consists in <p style="color:#009933;">#009933</p> for green, <p style="color:#3BBD67;">#3BBD67</p> for light green and no more than shades of grey). Bootstrap is used as main CSS framework.
